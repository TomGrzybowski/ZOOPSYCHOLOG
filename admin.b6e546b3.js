 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rt=new E(3e4,6e4);function Ot(){const e=Je().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let At=null;function Ct(e){return At=At||function(e){return new Promise(((t,i)=>{var n,r,o;function s(){Ot(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Ot(),i(g(e,"network-request-failed"))},timeout:Rt.get()})}if(null===(r=null===(n=Je().gapi)||void 0===n?void 0:n.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=Je().gapi)||void 0===o?void 0:o.load)){const t=ot("iframefcb");return Je()[t]=()=>{gapi.load?s():i(g(e,"network-request-failed"))},rt(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>i(e)))}s()}})).catch((e=>{throw At=null,e}))}(e),At}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
